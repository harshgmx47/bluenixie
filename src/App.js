          ...
          <div className='collapse navbar-collapse' id='navbarExample01'>
            <MDBNavbarNav right className='mb-2 mb-lg-0'>
              <MDBNavbarItem active>
                <MDBNavbarLink className="small-font-navbar" aria-current='page' href='#'>
                  Home
                </MDBNavbarLink>
              </MDBNavbarItem>
              <MDBNavbarItem>
              ...
              <MDBNavbarItem>
                <MDBNavbarLink className="small-font-navbar" href='#'>About Us</MDBNavbarLink>
              </MDBNavbarItem>
              <MDBNavbarItem>
            ...
            <MDBNavbarNav className='mb-2 mb-lg-0'>
            <MDBNavbarItem>
                <MDBNavbarLink className="small-font-navbar" href='#'>Sign In</MDBNavbarLink>
              </MDBNavbarItem>
              </MDBNavbarNav>
          </div>
